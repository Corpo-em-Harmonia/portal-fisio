...
export class SessaoService {
  private readonly baseUrl = `${API_CONFIG.baseUrl}/sessoes`;
  private readonly avaliacoesBaseUrl = `${API_CONFIG.baseUrl}/avaliacoes`;
  private readonly pacientesBaseUrl = `${API_CONFIG.baseUrl}/pacientes`;
